#include "minotaur.h" include <stdlib.h> include <stdint.h> include <string.h> include <stdio.h> include <sha3/sph_blake.h> include 
#<sha3/sph_bmw.h> include <sha3/sph_groestl.h> include <sha3/sph_jh.h> include <sha3/sph_keccak.h> include <sha3/sph_skein.h> include 
#<sha3/sph_luffa.h> include <sha3/sph_cubehash.h> include <sha3/sph_shavite.h> include <sha3/sph_simd.h> include <sha3/sph_echo.h> 
#include <sha3/sph_hamsi.h> include <sha3/sph_fugue.h> include <sha3/sph_shabal.h> include <sha3/sph_whirlpool.h> include 
#<sha3/sph_sha2.h>
// Config
#define MINOTAUR_ALGO_COUNT 16
//#define MINOTAUR_DEBUG typedef struct TortureNode TortureNode; typedef struct TortureGarden TortureGarden; // Graph of hash algos plus 
SPH contexts struct TortureGarden {
...
// Get a 64-byte hash for given 64-byte input, using given TortureGarden contexts and given algo index void get_hash(void *output, const 
void *input, TortureGarden *garden, unsigned int algo) {
...
// Recursively traverse a given torture garden starting with a given hash and given node within the garden. The hash is overwritten with 
the final hash. void traverse_garden(TortureGarden *garden, void *hash, TortureNode *node) {
...
// Associate child nodes with a parent node inline void link_nodes(TortureNode *parent, TortureNode *childLeft, TortureNode *childRight) 
{
    parent->childLeft = childLeft;
    parent->childRight = childRight;
}
// Produce a 32-byte hash from 80-byte input data void minotaurhash(void *output, const void *input) {
...
// Scan driver int scanhash_minotaur(int thr_id, struct work *work, uint32_t max_nonce, uint64_t *hashes_done) {
